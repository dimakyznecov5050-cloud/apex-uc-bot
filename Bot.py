...
def menu_keyboard():
    ...
    markup.add(build_inline_button('Купить UC', 'menu_uc', BUY_EMOJI_ID))
    markup.add(
    ...
    markup.add(
        ...
        build_inline_button('Профиль', 'menu_profile', '5447410659077661506')
    )
    markup.add(
        build_inline_button('Telegram Stars', 'menu_tgstars', TG_STARS_EMOJI_ID),
        build_inline_button('Telegram Premium', 'menu_tgpremium', TG_PREMIUM_EMOJI_ID)
    )
    markup.add(
