...
if __name__ == '__main__':
    ...
    while True:
        try:
            print('🌐 Проверяю соединение с Telegram...')
            me = bot.get_me()
            print(f'✅ Успешное подключение к Telegram: @{me.username}')
        ...
        except (ReadTimeout, ConnectionError, ReadTimeoutError, RequestException) as e:
